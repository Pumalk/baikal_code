const cardsData = {
  ...
  card_2: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/живокость крупноцветковая.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_4: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/хвощ полевой.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_5: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/пион уклоняющийся.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_6: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/проломник северный.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_9: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/Хвойник односемянный.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_12: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/чистотел большой.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_13: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/родиола розовая.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_14: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/тимьян монгольский.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
      herbariumLink: "",
  ...
  card_15: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/боярышник кроваво-красный.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
      herbariumLink: "",
  ...
  card_16: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/зверобой продырявленный.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
      herbariumLink: "",
  ...
  card_17: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/рододендрон аддамса.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
      herbariumLink: "",
  ...
  card_18: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/облепиха крушиновидная.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
      herbariumLink: "",
  ...
  card_19: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/панцерина шерстистая.jpg" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
