const cardsData = {
  card_1: {
    ...
    image: "media/cards/cards_photo/шлемник байкальский.webp",
  ...
  card_2: {
    ...
    image: "media/cards/cards_photo/живокость крупноцветковая.webp",
    fact: "Эти синие цветы, похожие на прыгающих дельфинов, скрывают опасный секрет – они ядовиты! В их стеблях содержится алкалоид дельфинин, который в древности использовали для отравленных стрел. Но в крошечных дозах это же вещество лечит нервные болезни и снимает боль. В пыльце живокости есть вещества, которые могут вызвать у пчёл «опьянение» - они становятся вялыми, теряют ориентацию и могут даже погибнуть. Иногда мёд, собранный с таких цветов, тоже становится вредным - его называют «пьяным мёдом», и он может быть опасен для людей. Растение цветёт всего несколько недель, успев за это время привлечь всех бабочек округи.",
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/живокость крупноцветковая.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_3: {
    ...
    image: "media/cards/cards_photo/зопник клубненосный.webp",
  ...
  card_4: {
    ...
    image: "media/cards/cards_photo/хвощ полевой.webp",
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/хвощ полевой.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_5: {
    ...
    image: "media/cards/cards_photo/пион уклоняющийся.webp",
    fact: "В Сибири этот цветок зовут «Марьин корень» и считают магическим растением. По легенде, если выкопать его корень в полнололуние, он будет отгонять кошмары. Учёные подтверждают – пион действительно успокаивает нервы лучше многих лекарств! Его бутоны похожи на маленькие розы, но раскрываются всего на 2 недели, успев привлечь всех окрестных пчёл. Интересно, что муравьи «охраняют» цветы – они питаются сладким соком бутонов и прогоняют другие насекомые. Но сорвать этот пион нельзя – он занесён в Красную книгу Бурятии!",
    modalContent: {
      fullDescription: "Вид многолетних травянистых растений рода Пион, семейства Пионовые (Paeoniaceae), высотой около 1 м.",
      sketchfabEmbed: `<img src="media/cards/зарисовки/пион уклоняющийся.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_6: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/проломник северный.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_7: {
    ...
    image: "media/cards/cards_photo/лилия карликовая.webp",
    fact: "За яркий цвет буряты называют лилию Улаалзай – «алая заря». Она пахнет так сильно, что аромат чувствуется за 10 шагов, привлекая ночных бабочек. Луковицы лилии съедобны – их вкус похож на картофель. ",
    modalContent: {
      ...
      sketchfabEmbed: `<div class="sketchfab-embed-wrapper"> 
      <iframe title="Лилия карликовая (лат. Lilium pumilum)" frameborder="0" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" allow="autoplay; 
      fullscreen; xr-spatial-tracking" xr-spatial-tracking execution-while-out-of-viewport 
      execution-while-not-rendered web-share src="https://sketchfab.com/models/05d3ddab443d49c6b0a4d9172ad8f71d/embed?autospin=1&autostart=1"> </iframe> </div>`,
  ...
  card_8: {
    ...
    image: "media/cards/cards_photo/Тысячелистник обыкновенный.webp",
    fact: "Это растение – природная аптечка! Его название «Ахиллея» появилось в честь мифического воина Ахилла, который лечил им раны. А ещё... это предсказатель погоды! Перед дождём листья тысячелистника скручиваются, защищая пыльцу. Его листья действительно разделены на 1000 мелких долек – попробуй сосчитать! В старину им останавливали кровь, жевали от зубной боли и даже гадали. ",
    modalContent: {
  ...
  card_9: {
    ...
    image: "media/cards/cards_photo/Хвойник односемянный.webp",
    fact: "Это не хвощ и не ёлочка, а древнейшее растение Земли – ровесник динозавров! Его веточки содержат эфедрин – вещество, которое расширяет бронхи. Монгольские воины брали его в походы, чтобы легче дышалось в горах. Ягоды хвойника похожи на бусины – ярко-красные и блестящие. Но есть их нельзя – они ядовиты! ",
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/Хвойник односемянный.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_11: {
    ...
    image: "media/cards/cards_photo/вьюнок полевой.webp",
    fact: "Этот хитрец – чемпион по скорости! Его ростки пробивают асфальт, а стебель за неделю вырастает на 10 см. Интересно, что у вьюнка есть «биочасы»: он раскрывается утром и закрывается во второй половине дня, но точное время зависит от погоды, освещения и климата. Будь осторожен – растение ядовито для лошадей. Зато бабочки и пчёлы его обожают!",
    modalContent: {
  ...
  card_12: {
    ...
    image: "media/cards/cards_photo/чистотел большой.webp",
    fact: "Чистотел большой легко узнать по ярко-оранжевому соку - он выглядит как капля краски! В старину его называли «бородавником»: соком прижигали бородавки и мазали кожу при воспалениях. Считалось, что растение «очищает тело», отсюда и название. Но внутрь чистотел пить нельзя — он ядовит. Его можно встретить почти везде: на опушках лесов, у заборов, около домов и вдоль дорог.",
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/чистотел большой.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_13: {
    ...
    image: "media/cards/cards_photo/родиола розовая.webp",
    fact: "Её называют «золотым корнем» неспроста – на изломе он блестит, как драгоценный металл! Это растение-энергетик: сибирские охотники брали его в долгие походы вместо шоколада. Оно растет очень высоко в горах. Интересно, что корень пахнет... розой! Отсюда название. Чтобы вырасти размером с ладонь, родиоле нужно около 5-10 лет. Поэтому если найдёшь её в горах – просто сфотографируй, не рви!",
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/родиола розовая.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_14: {
    ...
    image: "media/cards/cards_photo/тимьян байкальский.webp",
    fact: "Эта душистая травка – природный антибиотик! Её клали в повязки воинам, чтобы раны не гноились. Пчёлы обожают тимьян – мёд из него пахнет лимоном и лечит кашель. Растение стелется по земле ковром, выдерживая морозы до -40°C! В Бурятии его называют «божественной травой» и добавляют в чай для бодрости. Попробуй растереть листочек пальцами – почувствуешь аромат лимона и мяты. ",
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/тимьян монгольский.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
      herbariumLink: "",
  ...
  card_15: {
    ...
    image: "media/cards/cards_photo/боярышник кроваво-красный.webp",
    fact: "Эти алые ягоды – сердечный доктор! Они содержат вещества, укрепляющие сосуды. По легенде, колючки боярышника – это заколдованные иглы феи, защищающие птичьи гнёзда. Растение-долгожитель: некоторые кусты живут 200 лет! Ягоды не боятся морозов – их можно собирать даже зимой. А ещё... из них делают натуральные чернила. Попробуй раздавить ягодку – сок оставит на бумаге розовый след. Только не уколись колючками – они длиннее, чем у розы!",
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/боярышник кроваво-красный.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
      herbariumLink: "",
  ...
  card_16: {
    ...
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/зверобой продырявленный.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
      herbariumLink: "",
  ...
  card_17: {
    ...
    image: "media/cards/cards_photo/рододендрон адамса.webp",
    fact: "Бурятские шаманы называют его «белое крыло» (Сагаан дали) и используют в обрядах. Листья пахнут... клубникой! Если заварить их в чае, он даст необычный фруктовый аромат. Растёт рододендрон в горах Байкала, Восточной Сибири, Монголии и Забайкалья, и выживает при -45°C. Чтобы собрать 1 кг листьев, нужно обойти 200 кустов – поэтому он такой дорогой. Интересно, что олени зимой выкапывают его из-под снега – видимо, знают о его целебной силе!",
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/рододендрон аддамса.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
      herbariumLink: "",
  ...
  card_18: {
    ...
    image: "media/cards/cards_photo/облепиха крушиновидная.webp",
    fact: "Это растение-феникс: после пожаров оно первым оживает на пепелище! Его ягоды – чемпионы по витаминам: в 6 раз больше витамина С, чем в лимоне. Древние греки лечили им лошадей – отсюда название Hippophae («лоснящаяся лошадь»). Ягоды так плотно сидят на ветках, что собирать их – всё равно что снимать бусины с нитки. Забавный факт: если заморозить ягоды, они станут сладкими – мороз разрушает горькие вещества. Попробуй зимой!",
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/облепиха крушиновидная.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
      herbariumLink: "",
  ...
  card_19: {
    ...
    image: "media/cards/cards_photo/панцерина шерстистая.webp",
    fact: " Это растение – барашек в мире трав! Оно покрыто белым «войлоком», защищающим от жары. Кочевники лечили им кашель у овец – отсюда название «шэмэдэг» (овечье лекарство). Интересно, что панцерина «курит»: в жару её эфирные масла испаряются, создавая лёгкую дымку. Попробуй погладить листочек – он мягкий, как плюшевая игрушка!",
    modalContent: {
      ...
      sketchfabEmbed: `<img src="media/cards/зарисовки/панцерина шерстистая.webp" alt="Ботаническая зарисовка" class="sketchfab-embed-wrapper">`,
  ...
  card_20: {
    ...
    image: "media/cards/cards_photo/кровохлебка лекарственная.webp",
    fact: "Страшное название – добрая душа! Её тёмно-красные «шишечки» останавливают кровь лучше пластыря. В войнах ею перевязывали раны – отсюда и название. Корни кровохлёбки – природная жевательная резинка: они имеют вяжущий вкус и освежают дыхание. А ещё кровохлебка является индикатором чистоты – она растёт только в экологичных местах. Попробуй потрогать соцветие – оно плотное, как шишка!",
    modalContent: {
