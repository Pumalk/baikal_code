const cardsData = {
  card_1: {
    ...
    fact: "Одно из главных растений в тибетской и китайской медицине. В Китае его называют «Хуан-Цин» и используют более 2000 лет. Это растение обладает уникальными свойствами: оно помогает снижать давление, успокаивает нервную систему и даже борется с воспалениями. Его корни содержат особые вещества, которые делают его таким полезным. Шлемник байкальский растет на каменистых склонах и в степях, предпочитая сухие и солнечные места.",
    modalContent: {
